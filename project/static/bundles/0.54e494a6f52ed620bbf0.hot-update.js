				...
				return _react3.default.createElement(
					...
					_react3.default.createElement(
						...
						_react3.default.createElement(
							...
							_react3.default.createElement(
								'a',
								{ className: 'btn-apply waves-effect waves-light btn', href: this.state.job.url, target: '_blank' },
								'Apply'
							),
							_react3.default.createElement(
								'a',
								{ className: 'btn-like waves-effect waves-light btn', href: '#', onClick: function onClick(e) {
										e.preventDefault();
